...
- **Редактирование услуги** – изменение параметров существующей услуги (но не её обновление, а создание новой версии с новыми параметрами и закрытие старой). В редактирование услуги включена возможность добавление или изменение правил.- **Удаление услуги** – снятие услуги с предоставления путем установки даты окончания действия.
...
- **Просмотр выбранных услуг** - просмотр запрашиваемых услуг в виде списка и их статусы("На рассмотрении", "Оказана" и т.д.). В том числе просмотр результатов услуги в случае ее выполнения или отказа.
...
- **Отображение результатов** выполнения услуги для пользователя.
